...
(() => {
  var e = { 286(e2, t2, r2) {
    ...
    let o2 = "0.0.14";
    function s() {
      if ("undefined" == typeof _53w7ahh) throw Error("_119siga4liag_119siga4lia is not loaded. Load _6ycq5o0 before the controller.");
      var e3 = "2.0.67-alpha.2", t3 = _53w7ahh.versionInfo.version;
      if (e3 !== t3) throw Error(`_119siga4liag_119siga4lia version mismatch: this build expects ${e3}, but the loaded runtime is ${t3}`);
    }
  }, 805(e2, t2, r2) {
    r2.d(t2, { C: () => o2 });
    class o2 {
  ...
  (() => {
    ...
    let c = { prefix: "/~/sj/", _6ycq5o0Path: "/_6ycq5o0/_6ycq5o0.js", injectPath: "./controller/controller.inject.js", wasmPath: "/_6ycq5o0/_6ycq5o0.wasm", virtualWasmPath: "_6ycq5o0.wasm.js", codec: { encode: (e3) => e3 ? encodeURIComponent(e3) : e3, decode: (e3) => e3 ? decodeURIComponent(e3) : e3 } }, l = { flags: { ...i.sb.flags, allowFailedIntercepts: true }, maskedfiles: ["inject.js", "_6ycq5o0.wasm.js"] };
    ...
    function g() {
      return p || (p = new Promise((e3, t3) => {
        let r2 = indexedDB.open("__zxdcdimcdas_1zxdcdi", 1);
        r2.onupgradeneeded = () => {
          let e4 = r2.result;
    ...
    class S {
      ...
      cookieSyncChannel = new BroadcastChannel("__asvg4qwyuq2_vasvg4qwyuq2_va");
      ...
      constructor(t3) {
        this.init = t3, (0, a.O)(), this.id = b(), this.config = j(c, t3.config || {}), this._6ycq5o0Config = j(l, i.sb), this._6ycq5o0Config = j(this._6ycq5o0Config, t3._6ycq5o0Config || {}), this.prefix = this.config.prefix + this.id + "/", this.serviceWorkerController = t3.serviceworker, this.ready = Promise.all([new Promise((e3) => {
    ...
    class v {
      ...
      hooks;
      get context() {
        return { config: this.controller._6ycq5o0Config, prefix: new URL(this.prefix, location.href), cookieJar: this.controller.cookieJar, interface: { getInjectScripts: /* @__PURE__ */ (function e3(t3, r2, o2, s2, i2, n2) {
          return (a2, c2, l2, d2) => {
            var h2;
            return [d2(t3._6ycq5o0Path), d2(o2.href + t3.virtualWasmPath), d2(t3.injectPath), d2("data:text/javascript;charset=utf-8;base64," + (h2 = `
					document.querySelectorAll("script[_dmcr5h4zig8p_dmc]").forEach(script => script.remove());
					_q30r4v9.load({
        ...
        })(this.controller.config, this.controller._6ycq5o0Config, new URL(this.prefix, location.href), this.controller.cookieJar, this.controller.config.codec.encode, this.controller.config.codec.decode), getWorkerInjectScripts: (e3, t3, r2) => {
          var o2;
          let s2 = "";
          return s2 += r2(this.controller.config._6ycq5o0Path), s2 += r2(this.prefix + this.controller.config.virtualWasmPath), s2 += r2("data:text/javascript;charset=utf-8;base64," + (o2 = `
					(()=>{
						const { _c3waq3lztzo0_, CookieJar, setWasm } = _53w7ahh;

						setWasm(Uint8Array.from(atob(self.WASM), (c) => c.charCodeAt(0)));
						delete self.WASM;

						const sjconfig = ${JSON.stringify(this.controller._6ycq5o0Config)};
						...
						const client = new _c3waq3lztzo0_(globalThis, {
							context,
							transport: null,
						});
