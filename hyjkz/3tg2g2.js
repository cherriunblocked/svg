(() => {
  ...
  var r, i, n, s, o, a, A = { 8770(e2, t2, r2) {
    ...
    r2.r(t2), r2.d(t2, { _c3waq3lztzo0_: () => p });
    ...
    class p {
      ...
      constructor(e3, t3) {
        if (this.global = e3, this.init = t3, n2.p in e3) throw d.error("_v52gn3jymngc_v52gn3jymngc_v52gn3jymngc_v52gn3jymngc_v52gn3jymngc_v52gn3jymngc_v52gn3jy"), new g.$D();
        if (c2.iswindow) {
        ...
        this.meta = { get origin() {
          ...
          if (!t4) return null;
          if (!t4.name) return d.error("_czw1eve0gwpo_czw1eve0gwpo_czw1eve0gwpo_czw1eve0gwpo_czw1eve0gwpo_c"), null;
          return t4.name;
        }, get parentFrameName() {
          ...
          try {
            ...
            }
            {
              ...
              if (!e5.name) return d.error("_czw1eve0gwpo_czw1eve0gwpo_czw1eve0gwpo_czw1eve0gwpo_czw1eve0gwpo_c"), null;
              return e5.name;
            }
          } catch {
            return null;
...
//# sourceURL=${A4}`)();
        ...
        r3.construct && (l3.construct = function(e4, t4, i4) {
          ...
          try {
            ...
            if (this.box.instanceof(e5, "Error")) if (this.box.instanceof(e5.stack, "Object")) {
              if (e5.stack = e5.stack.stack, console.error("_5brekh3zjxif_5brekh3zjxif_5b", e5), !this.flagEnabled("allowFailedIntercepts")) throw g.$D.prepareStackTrace = A4, e5;
    ...
    function n2(e3) {
      e3.Trap("Element.prototype.attributes", { get(e4) {
        ...
        }, has: (e5, r4) => "symbol" == typeof r4 ? (0, i2.d2)(e5, r4) : !(r4.startsWith("_c35ke52b73vz-") || t3[r4]?.name?.startsWith("_c35ke52b73vz-")) && (0, i2.d2)(e5, r4) });
        return r3;
    ...
    function p(e3, t3, r3, i3) {
      ...
      for (let r4 of e3.natives.call("Element.prototype.getAttributeNames", t3) ?? []) {
        if ((0, n2.Qf)(r4).startsWith("_c35ke52b73vz")) continue;
    ...
    function f(e3, t3) {
      ...
      e3.Trap("Node.prototype.baseURI", { get(t4) {
        ...
        let [r4] = t4.args;
        if (r4.startsWith("_c35ke52b73vz")) return t4.return(null);
        if (e3.natives.call("Element.prototype.hasAttribute", t4.this, `_c35ke52b73vz-${r4}`)) {
          let e4 = t4.fn.call(t4.this, `_c35ke52b73vz-${r4}`);
          return null === e4 ? t4.return("") : t4.return(e4);
        }
      } }), e3.Proxy("Element.prototype.getAttributeNames", { apply(e4) {
        let t4 = e4.call().filter((e5) => !e5.startsWith("_c35ke52b73vz"));
        e4.return(t4);
      } }), e3.Proxy("Element.prototype.getAttributeNode", { apply(e4) {
        if ((0, n2.Qf)(e4.args[0]).startsWith("_c35ke52b73vz")) return e4.return(null);
      } }), e3.Proxy("Element.prototype.hasAttribute", { apply(e4) {
        if ((0, n2.Qf)(e4.args[0]).startsWith("_c35ke52b73vz")) return e4.return(false);
        ...
        if (a3) {
          ...
          if (null == i3) {
            e3.natives.call("Element.prototype.removeAttribute", t4.this, r4), t4.fn.call(t4.this, `_c35ke52b73vz-${r4}`, s3), t4.return(void 0);
            return;
          }
          t4.args[1] = i3, t4.fn.call(t4.this, `_c35ke52b73vz-${t4.args[0]}`, s3);
        }
        ...
        o3 && (t4.args[2] = o3.fn(s3, e3.context, e3.meta, p(e3, t4.this, r4, s3)), e3.natives.call("Element.prototype.setAttribute", t4.this, `_c35ke52b73vz-${t4.args[1]}`, s3));
        ...
        let r4 = (0, n2.Qf)(t4.args[0]);
        if (r4.startsWith("_c35ke52b73vz")) return t4.return(void 0);
        e3.natives.call("Element.prototype.hasAttribute", t4.this, r4) && t4.fn.call(t4.this, `_c35ke52b73vz-${t4.args[0]}`);
      } }), e3.Proxy("Element.prototype.toggleAttribute", { apply(t4) {
        let r4 = (0, n2.Qf)(t4.args[0]);
        if (r4.startsWith("_c35ke52b73vz")) return t4.return(false);
        e3.natives.call("Element.prototype.hasAttribute", t4.this, r4) && t4.fn.call(t4.this, `_c35ke52b73vz-${t4.args[0]}`);
        ...
        if (e3.box.instanceof(t4.this, "HTMLScriptElement") && (0, h2.Kx)(c3)) i3 = (0, A2.o)(l3, "(anonymous script element)", e3.context, e3.meta, (0, h2.g)(c3)), e3.natives.call("Element.prototype.setAttribute", t4.this, "_c35ke52b73vz-script-source-src", (0, s2.i)((0, n2.vh)(i3)));
        ...
        if (e3.box.instanceof(t4.this, "HTMLScriptElement")) {
          let r4 = e3.natives.call("Element.prototype.getAttribute", t4.this, "_c35ke52b73vz-script-source-src");
      ...
      let w = (t4, r4) => {
        ...
        if (e3.box.instanceof(t4, "HTMLScriptElement") && (0, h2.Kx)(i3)) {
          ...
          return e3.natives.call("Element.prototype.setAttribute", t4, "_c35ke52b73vz-script-source-src", (0, s2.i)((0, n2.vh)(r4))), o3;
        }
        return e3.box.instanceof(t4, "HTMLStyleElement") ? (0, o2.s)(r4, e3.context, e3.meta) : r4;
      }, y = (t4, r4) => {
        if (e3.box.instanceof(t4, "HTMLScriptElement")) {
          let i3 = e3.natives.call("Element.prototype.getAttribute", t4, "_c35ke52b73vz-script-source-src");
    ...
    r2.r(t2), r2.d(t2, { _c3waq3lztzo0_: () => i2._c3waq3lztzo0_, createLocationProxy: () => o2.createLocationProxy, getOwnPropertyDescriptorHandler: () => s2.getOwnPropertyDescriptorHandler, isdedicated: () => n2.isdedicated, isshared: () => n2.isshared, issw: () => n2.issw, iswindow: () => n2.iswindow, isworker: () => n2.isworker });
    ...
    let o2 = (0, s2.Rq)("_j2k12hyw3zlg_j2k12hyw3zlg_j2k12hy");
    function a2(e3, t3) {
      let r3 = { message: { _init() {
        ...
        return i2.iswindow ? "object" == typeof this.data && "$s7mwgng7shmp_s7" in this.data ? this.data.$s7mwgng7shmp_s7 : e3.url.origin : "";
      }, data() {
        return "object" == typeof this.data && "$eea0uq5d26pu_" in this.data ? this.data.$eea0uq5d26pu_ : this.data;
      } }, hashchange: { oldURL() {
    ...
    function a2(e3, t3) {
      i2.iswindow && e3.Proxy("window.postMessage", { apply(e4) {
        ...
        e4.args[0] = { $hvjdszm8u2gc_hvjdszm: "window", $s7mwgng7shmp_s7: s3 ? r4.global.parent[n2.p].url.origin : r4.url.origin, $eea0uq5d26pu_: e4.args[0] }, "string" == typeof e4.args[1] && (e4.args[1] = "*"), "object" == typeof e4.args[1] && (e4.args[1].targetOrigin = "*"), e4.return(i3.call(e4.fn, ...e4.args));
      } }), e3.Proxy("BroadcastChannel.prototype.postMessage", { apply(t4) {
        t4.args[0] = { $hvjdszm8u2gc_hvjdszm: "window", $s7mwgng7shmp_s7: e3.url.origin, $eea0uq5d26pu_: t4.args[0] };
      } });
      ...
      t3.Worker && r3.push("Worker.prototype.postMessage"), i2.iswindow || r3.push("self.postMessage"), e3.Proxy(r3, { apply(e4) {
        e4.args[0] = { $hvjdszm8u2gc_hvjdszm: "worker", $eea0uq5d26pu_: e4.args[0] };
    ...
    var i2 = r2(5994);
    let n2 = (0, i2.Rq)("_0g832lincgq7_0g832lincg");
    function s2(e3, t3) {
      (0, i2.pS)(t3.Object.prototype, "$lrnj7zdmx8wv_lrnj7z", { value(e4) {
    ...
    function l2(e3, t3) {
      (0, o2.pS)(t3, e3.config.globals.wrapfn, { value: e3.wrapfn, writable: false, configurable: false, enumerable: false }), (0, o2.pS)(t3, e3.config.globals.wrappropertyfn, { value: function(t4) {
        ...
        let r3 = typeof e4;
        return "object" === r3 && null !== e4 ? (location, i2.iswindow && t3.top) : "string" === r3 && (e4.includes("_6ycq5o0"), e4.includes("~/sj"), e4.includes(location.origin)), e4;
...
//# sourceURL=${r3.url.href}`), n3;
  ...
  `, `${"debug" === e3 ? "color: gray" : ""}`, ...i3);
    ...
    function b(e3, t3, r3, p2) {
      ...
      B.write(e3), B.end(), g.C.dispatch(t3.hooks.rewriter.html.pre, { handler: x2, meta: r3, htmlcontext: p2, origHtml: e3 }, void 0), (function e4(t4, r4, i3) {
        if ("base" === t4.name && void 0 !== t4.attribs.href && (i3.base = new d.xP(t4.attribs.href, i3.origin)), t4.attribs) {
          for (let e5 of c2.V) for (let n3 in e5) {
            ...
            if ("function" != typeof s3 && ("*" === s3 || s3.includes(t4.name)) && void 0 !== t4.attribs[n3]) {
              ...
              null === o3 ? delete t4.attribs[n3] : t4.attribs[n3] = o3, t4.attribs[`_c35ke52b73vz-${n3}`] = s4;
            }
          }
          for (let [e5, n3] of (0, d.nJ)(t4.attribs)) S.includes(e5) && (t4.attribs[`_c35ke52b73vz-${e5}`] = n3, t4.attribs[e5] = (0, l2.o)(n3, `(inline ${e5} on element)`, r4, i3));
        }
        ...
        if ("script" === t4.name && t4.attribs && void 0 !== t4.children[0]) {
          ...
          if ((0, f.Kx)(e5)) {
            ...
            t4.attribs["_c35ke52b73vz-script-source-src"] = (0, u.i)((0, d.vh)(n3)), n3 = n3.replace(/<!--[\s\S]*?-->/g, ""), t4.children[0].data = (0, l2.o)(n3, "(inline script element)", r4, i3, s3);
          }
        }
      ...
      if (p2.loadScripts) {
        let e4 = t3.interface.getInjectScripts(r3, x2, p2, (e5) => new s2.Hg("script", { src: e5, "_dmcr5h4zig8p_dmc": "true" }));
    ...
    function C(e3, t3) {
      ...
      return i3.write(e3), i3.end(), !(function e4(t4) {
        if ("attribs" in t4) for (let e5 in t4.attribs) {
          if ("_c35ke52b73vz-script-source-src" == e5) {
            t4.children[0] && "data" in t4.children[0] && (t4.children[0].data = (0, d.lw)(t4.attribs[e5]));
            continue;
          }
          e5.startsWith("_c35ke52b73vz-") && (t4.attribs[e5.slice(14)] = t4.attribs[e5], delete t4.attribs[e5]);
        }
...
`, c2 = r3.interface.getWorkerInjectScripts(a3, A2, l2), h2 = (0, n2.o)(e3, t3, r3, a3, A2);
    ...
    r2.d(t2, { _: () => n2, p: () => s2 });
    var i2 = r2(5994);
    let n2 = "_8gbtxtukzlop_8gbtxtuk", s2 = (0, i2.Rq)(n2);
  }, 3235(e2, t2, r2) {
    r2.d(t2, { Sr: () => l2, W_: () => c2 });
